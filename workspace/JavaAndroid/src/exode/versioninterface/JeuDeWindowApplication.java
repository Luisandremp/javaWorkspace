...
public class JeuDeWindowApplication implements IHMI {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ControlerI controler = new Controler();

                    controler.setIHMI(window);
                    window.setControlerI(controler);
    ...
    @Override
    public void setControlerI(ControlerI controlerI) {
        controler = controlerI;
    }
}
